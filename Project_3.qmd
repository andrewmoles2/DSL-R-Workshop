...
temps_f <- temperature_convert(temps, "F")
...
Try first to get a make an output for just the first hour, like the result below, using vector indexing to get the data you need. Then use string concatenation to bring all the information together to create a text output. 
...
Can you also get the result to be a list as two columns.
